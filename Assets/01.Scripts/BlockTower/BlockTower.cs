...
public class BlockTower : MonoBehaviour
{
    ...
    void TriggerGameOver()
    {
        ...
        ClearDetachedBlocks();
        ShowResultHud(gameOverVisualTree, "Assets/01.Scripts/UI/GameOverScreen.uxml", "GAME OVER", _score, targetScore, Rebuild);
    }
    ...
    void TriggerClear()
    {
        ...
        if (_heldRoot != null) { Destroy(_heldRoot); _heldRoot = null; _isHolding = false; }
        ClearDetachedBlocks();
        ShowResultHud(clearVisualTree, "Assets/01.Scripts/UI/ClearScreen.uxml", "CLEAR", _score, targetScore, Rebuild);
    }
