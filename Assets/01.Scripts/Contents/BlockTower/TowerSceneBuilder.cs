...
public class TowerSceneBuilder : MonoBehaviour
{
    ...
    public void CreateFloor()
    {
        ...
        else
        {
            ...
            {
                var existing = _tower.FindSceneObject("Floor");
                if (existing != null)
    ...
    public void CreateBoundaries()
    {
        ...
        {
            var existing = _tower.FindSceneObject("BoundaryLeft");
            if (existing != null) _tower.SetLeftBoundary(existing.gameObject);
        }

        if (_tower.RightBoundary == null)
        {
            var existing = _tower.FindSceneObject("BoundaryRight");
    ...
    public void UpdateTowerStackDivider()
    {
        ...
        {
            var existing = _tower.FindTowerChildObject("TowerStackDivider");
            if (existing != null)
            {
        ...
        {
            _tower.ParentToSelf(towerStackDivider.transform);
        }

        float minX = _tower.PlacementMinCell.x;
        float maxX = _tower.PlacementMaxCell.x + 1f;
        ...
        _tower.SetPlacementTowerStackDivider(towerStackDivider.transform);
        _tower.AlignPlacementZoneToDividerY(y);
    }
